...
# Output
OUT_DIR = "reaction_dataset_prediction_not_min_edits"
SAVE_MODEL = True
MODEL_NAME = "model.pt"
...
def main() -> None:
    ...
    if RUN_SINGLE_REACTION_DEMO:
        demo_cfg = DemoMonitorConfig(
            ...
            index_scale=INDEX_SCALE,
            embedding_grid=(8, 8),
            node_embedding_vmin=DEMO_NODE_HEATMAP_VMIN,
            node_embedding_vmax=DEMO_NODE_HEATMAP_VMAX,
            decoder_vmin=DEMO_DECODER_HEATMAP_VMIN,
            decoder_vmax=DEMO_DECODER_HEATMAP_VMAX,
        )
